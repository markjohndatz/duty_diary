                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select name="role" id="role" class="form-control">
                                ...
                                <option value="2" {{ $user->role_as == 2 ? 'selected' : ''}}>Supervisor</option>
                                <option value="3" {{ $user->role_as == 3 ? 'selected' : ''}}>Trainee</option>
                            </select>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="email" class="form-control" id="inputEmail4" id="Email" name="email" required value="{{ $user->email }}">
                        </div> 
